...
**Most recent disclosure:** 1960-03
...
bears on the subsystem `control-state-estimation`.
...
### 1960-03 — Kalman Filter (Rudolf Kalman 1960; optimal state estimation)

- **id:** `kalman-filter-1960`
- **corpus:** academic
- **ip status:** public-domain
- **creator:** Research Institute for Advanced Study (RIAS), Baltimore; Rudolf E. Kálmán
- **disclosure citation:** Kalman, R.E. 'A New Approach to Linear Filtering and Prediction Problems'. Transactions of the ASME — Journal of Basic Engineering 82(1):35-45, March 1960. Research Institute for Advanced Study (RIAS), Baltimore. Kalman-Bucy filter (continuous-time version) 1961.
- **disclosed subsystems:** `control-state-estimation`

**Prior art notes:**

> The Kalman Filter (Rudolf Kalman RIAS 1960; Kalman-Bucy 1961) is the foundational recursive optimal state estimator. 65-year-deep public-domain prior art. The heart of every navigation + tracking + sensor-fusion system in robotics.

**Sources:**

1. Kalman, R.E. ASME J. Basic Engineering 82(1):35-45, 1960.
