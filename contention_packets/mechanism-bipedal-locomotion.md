...
**Entries:** 118 (91 commons-grade, 27 draft)  
...
bears on the subsystem `mechanism-bipedal-locomotion`.
...
### 1979-04-07 — RX-78-2 Gundam *(draft)*

- **id:** `gundam-rx-78-2`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Yoshiyuki Tomino / Sunrise
- **disclosure citation:** Tomino, Yoshiyuki (dir.). Mobile Suit Gundam, first aired 1979-04-07.
- **disclosed subsystems:** `actuator-hydraulic`, `mechanism-bipedal-locomotion`

**Prior art notes:**

> The Gundam franchise's detailed mechanical specifications (published in 'Mechanical Documentary' supplements) constitute extensive design-fiction prior art for piloted humanoid mecha.

**Sources:**

1. Mobile Suit Gundam (1979).
2. MS Encyclopedia and various Mechanical Documentary publications.
...
- **disclosure citation:** Honda Motor Co. internal program, publicly disclosed retrospectively in Honda's ASIMO documentation.
- **disclosed subsystems:** `actuator-electric-harmonic-drive`, `mechanism-bipedal-locomotion`, `power-tethered`

**Prior art notes:**

> First in the Honda lineage that culminates in ASIMO. Establishes Honda's commitment to electric over hydraulic for humanoid bipedal locomotion. Anticipates: electric-actuator bipedal walking platforms.

**Sources:**

1. Honda ASIMO history page.
2. Hirose, M. and Ogawa, K. 'Honda humanoid robots development.' Phil. Trans. R. Soc. A 365, 11–19 (2007).
...
- **disclosed subsystems:** `actuator-electric-direct-drive`, `mechanism-bipedal-locomotion`, `power-tethered`

**Prior art notes:**

> Step in the Honda E-series lineage. Hirose/Ogawa 2007 documents the entire E0–E6 progression with sufficient specificity to anticipate basic electric-actuated bipedal walking claims for that era.
...
- **creator:** Honda Motor Co.
- **disclosure citation:** Hirose, M. and Ogawa, K. 'Honda humanoid robots development.' Phil. Trans. R. Soc. A 365, 11–19 (2007).
- **disclosed subsystems:** `actuator-electric-direct-drive`, `mechanism-bipedal-locomotion`, `sensing-imu`, `power-tethered`

**Prior art notes:**

> E2 is the transition from static to dynamic walking in the Honda program. Disclosure relevant to dynamic bipedal walking claims.
...
> Step in Honda E-series. Walking-speed progression relevant to bipedal locomotion speed claims.
...
> Knee-bending dynamic walking variant in the Honda lineage.
...
- **creator:** Honda Motor Co.
- **disclosure citation:** Hirose, M. and Ogawa, K. 'Honda humanoid robots development.' Phil. Trans. R. Soc. A 365, 11–19 (2007).
- **disclosed subsystems:** `actuator-electric-direct-drive`, `mechanism-bipedal-locomotion`, `sensing-imu`, `power-li-ion`

**Prior art notes:**

> E5 transitioned the Honda program from tethered to self-contained operation. Relevant to battery-powered bipedal walking claims.
...
> Final E-series model before transition to P-series. Relevant to bipedal stair-climbing claims.
...
- **disclosure citation:** Boston Dynamics PETMAN program, DOD-funded, public videos beginning 2009.
- **disclosed subsystems:** `actuator-hydraulic`, `mechanism-bipedal-locomotion`, `power-tethered`

**Prior art notes:**

> Direct ancestor of Atlas; establishes Boston Dynamics' hydraulic bipedal lineage.
