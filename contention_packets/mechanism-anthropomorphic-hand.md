...
**Entries:** 113 (91 commons-grade, 22 draft)  
...
bears on the subsystem `mechanism-anthropomorphic-hand`.
...
### 1964-06 — The Greatest Robot on Earth (eight mecha disclosures)

- **id:** `astro-boy-greatest-robot`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Osamu Tezuka
- **disclosure citation:** Tezuka, Osamu. 'The Greatest Robot on Earth' (chizujō saidai no robotto). Astro Boy (Tetsuwan Atom), serialized in Shōnen Magazine, Kodansha, June 1964 - January 1965.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `mechanism-anthropomorphic-hand`, `actuator-electric-direct-drive`, `actuator-hydraulic`

**Prior art notes:**

> Tezuka's 1964 'Greatest Robot on Earth' arc is one of the most engineering-detailed fictional disclosures of mecha designs in any medium. Eight named platforms, each with a specific power source, propulsion, weapon, and sensor configuration — each anticipating distinct modern claims. Mont Blanc's diesel-hydraulic forestry humanoid anticipates industrial humanoid IP. Gesicht's photon-emitter eyes + EMP capability anticipate sensor-and-countermeasure-integrated humanoid IP. Hercules' magnetic propulsion anticipates non-rotating-actuator humanoid claims. Astro's retractable rocket-boot legs anticipate transformation-mode bipedal IP. The arc is continuously republished, has been adapted to film/TV multiple times (most importantly Urasawa's Pluto 2003-2009), and has the unusual property of multiple mechanism disclosures in a compressed publication window.
...
### 1968-10 — The Vision *(draft)*

- **id:** `vision-marvel`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Roy Thomas and John Buscema
- **disclosure citation:** Thomas, Roy and Buscema, John. The Avengers #57. Marvel Comics, October 1968.
- **disclosed subsystems:** `mechanism-anthropomorphic-hand`, `actuator-hydraulic`

**Prior art notes:**

> Density-modulating humanoid mechanism. The 'phase through walls' and 'become diamond-hard' modes are functionally a disclosure of variable-stiffness humanoid material — anticipates modern variable-impedance / variable-compliance humanoid IP. Continuously in print since 1968; widely indexed.

**Sources:**

1. Thomas, R. and Buscema, J. The Avengers #57. Marvel Comics, 1968.
2. Englehart, S. and Buscema, J. The Avengers (Vision lineage, 1972-1977 run).
...
### 1976 — Andrew (The Bicentennial Man) *(draft)*

- **id:** `asimov-bicentennial-man`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Isaac Asimov
- **disclosure citation:** Asimov, Isaac. 'The Bicentennial Man'. Stellar Science-Fiction Stories #2 (Judy-Lynn del Rey, ed.), Ballantine, February 1976.
- **disclosed subsystems:** `mechanism-anthropomorphic-hand`

**Prior art notes:**

> Disclosure of a humanoid that progressively replaces mechanical components with biological prostheses over decades — anticipates modern claims on humanoid platforms with field-replaceable subsystem upgrades (Apptronik, 1X both have related IP). Less mechanically specific than Caves of Steel but the *progressive replacement architecture* is a clear novel anticipation. Won the Hugo, Nebula, and Locus awards in 1977; canonical reference.

**Sources:**

1. Asimov, I. 'The Bicentennial Man'. Stellar #2, Ballantine, 1976.
2. Asimov, I. and Silverberg, R. The Positronic Man. Doubleday, 1992 (novelization).
...
- **disclosure citation:** Cameron, James (dir.). The Terminator. Orion Pictures, released 1984-10-26.
- **disclosed subsystems:** `actuator-hydraulic`, `mechanism-bipedal-locomotion`, `mechanism-anthropomorphic-hand`

**Prior art notes:**

> The film's prop work and dialogue establish detailed mechanical anatomy specifications that have been cited in robotics literature as conceptual prior art for combat-rated humanoid chassis design.
...
### 2003-07-15 — HK-47 *(draft)*

- **id:** `hk-47-kotor`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** BioWare
- **disclosure citation:** BioWare, Knights of the Old Republic. LucasArts, July 15, 2003.
- **disclosed subsystems:** `mechanism-anthropomorphic-hand`, `actuator-electric-direct-drive`

**Prior art notes:**

> Specific disclosure of weapon-integrated humanoid forearm and photoreceptor sensor head. Anticipates: (1) integrated weapon mount in humanoid forearm — relevant to defense/security humanoid IP (a small but real market); (2) photoreceptor sensor head with explicit visual indicator — relevant to anthropomorphic-eye sensor claims. Continuously available since 2003.

**Sources:**

1. BioWare. Knights of the Old Republic. LucasArts, 2003.
