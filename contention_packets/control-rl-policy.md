...
**Entries:** 123 (97 commons-grade, 26 draft)  
...
bears on the subsystem `control-rl-policy`.
...
### 1963-02 — Magnus, Robot Fighter (4000 A.D.) *(draft)*

- **id:** `magnus-robot-fighter`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Russ Manning
- **disclosure citation:** Manning, Russ (writer/artist). Magnus, Robot Fighter 4000 AD #1. Gold Key Comics, February 1963.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `control-rl-policy`

**Prior art notes:**

> Magnus Robot Fighter establishes the trope of mass-produced humanoid civic deployment 60+ years before commercial efforts. Anticipates: (1) humanoid platforms specialized by job function (police variant, industrial variant, transit variant) — relevant to morphology-family humanoid IP claims (Apptronik, 1X both have related lineage); (2) centralized AI fleet coordination across mass-produced humanoid units — relevant to fleet-management humanoid IP. Continuously in print across multiple publishers since 1963.

**Sources:**

1. Manning, R. Magnus Robot Fighter 4000 AD. Gold Key Comics 1963-1977; Valiant 1991-1996; Dark Horse 2010s.

---

### 1965 — Trurl and Klapaucius (The Cyberiad)

- **id:** `lem-cyberiad`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Stanisław Lem (translated by Michael Kandel)
- **disclosure citation:** Lem, Stanisław. Cyberiada. Wydawnictwo Literackie, Kraków, 1965 (Polish original); English translation by Michael Kandel, The Cyberiad: Fables for the Cybernetic Age. Seabury Press, 1974.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `control-rl-policy`

**Prior art notes:**

> Lem's Cyberiad (1965, English 1974) is one of the most engineering-grounded fiction collections about humanoid robotics. Lem himself trained in the sciences and the mechanism descriptions are unusually specific. Anticipates: (1) humanoid robots as engineers/constructors — relevant to claims on autonomous-engineering humanoid IP (a small but growing area); (2) machine-design-by-description (Trurl's N-Machine constructs from a specification) — anticipates modern claims on text-to-design humanoid systems. Continuously in print since 1965 (Polish) and 1974 (English).

**Sources:**

1. Lem, S. Cyberiada. Wydawnictwo Literackie, 1965.
2. Lem, S. The Cyberiad: Fables for the Cybernetic Age (translated by Kandel). Seabury Press, 1974; reprinted Harvest, 1985.

---

### 1965-10 — Sentinels (X-Men)

- **id:** `sentinels-marvel`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Stan Lee and Jack Kirby
- **disclosure citation:** Lee, Stan and Kirby, Jack. The X-Men #14, 'Among Us Stalk... The Sentinels!'. Marvel Comics, November 1965.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `actuator-electric-direct-drive`, `control-rl-policy`

**Prior art notes:**

> Lee-Kirby's 1965 Sentinels predate Ultron by 3 years and establish the mass-production-via-Master-Mold-factory architecture. Anticipates: (1) factory-autonomous mass-production of combat humanoids — relevant to modern claims on autonomous humanoid manufacturing IP; (2) online learning between deployments — relevant to fleet-policy-update IP that learns from real-world experience (Tesla Optimus and 1X both have related claims); (3) specific-target-population detection as the targeting policy — relevant to claims on demographic-aware humanoid platforms (a niche but real area). Continuously in print since 1965.

**Sources:**

1. Lee, S. and Kirby, J. The X-Men #14-16. Marvel Comics, 1965-1966.
2. Marvel Sentinels continuity (1965-present).

---

### 1966-03 — Frost and Betelgeuse

- **id:** `zelazny-frost-betelgeuse`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Roger Zelazny
- **disclosure citation:** Zelazny, Roger. 'For a Breath I Tarry'. Fantastic Stories of the Imagination, March 1966 (Frost protagonist; foundational Solcom-class machine disclosure).
- **disclosed subsystems:** `actuator-electric-direct-drive`, `control-rl-policy`
...
1. Zelazny, R. 'For a Breath I Tarry'. Fantastic Stories of the Imagination, March 1966.
2. Zelazny, R. The Last Defender of Camelot. Pocket Books, 1980 (collected anthology including the novella).
...
- **disclosure citation:** Fujiko F. Fujio (Hiroshi Fujimoto). Doraemon (ドラえもん). CoroCoro Comic / Yoiko / Yōchien (multiple Shogakukan magazines), December 1, 1969 - 1996.
- **disclosed subsystems:** `control-rl-policy`
...
1. Fujiko F. Fujio. Doraemon. Shogakukan magazines, 1969-1996 (collected in 45 tankōbon volumes plus expanded volumes).
2. Doraemon official secret-tools database (Shogakukan).

---

### 1972-03-10 — Huey, Dewey, and Louie (Silent Running)

- **id:** `silent-running-drones`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Douglas Trumbull, Universal Pictures
- **disclosure citation:** Trumbull, Douglas (dir.); Hill, Deric and Cocks, Steven and Wilhelm, Mike and Cimino, Michael (writers). Silent Running. Universal Pictures, March 10, 1972.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `mechanism-anthropomorphic-hand`, `control-rl-policy`

**Prior art notes:**

> Silent Running's drones provide an unusually engineering-grounded fictional disclosure: the on-set drones were *physically functional* compact bipedal humanoid platforms, operated by performers inside, and the production team published behind-the-scenes documentation of the mechanism. Anticipates: (1) compact (sub-meter) bipedal humanoid mechanism with internal volume for human-equivalent operator — relevant to claims on small-form-factor humanoid IP; (2) task-learning-from-demonstration (Lowell teaches drones gardening) — relevant to imitation-learning humanoid claims; (3) multi-unit cooperative humanoid task allocation. The film itself plus the production documentation (exhibit at the Smithsonian) provide a documented mechanism disclosure.

**Sources:**

1. Trumbull, D. Silent Running. Universal, 1972.
2. Bizony, P. The Making of Stanley Kubrick's 2001 (which discusses Trumbull's later work and the Silent Running drones).
...
### 1977-04 — Machine Man (X-51, Aaron Stack) *(draft)*

- **id:** `machine-man-marvel`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Jack Kirby; Marvel Comics
- **disclosure citation:** Kirby, Jack (writer/artist). 2001: A Space Odyssey #8 - 'Mister Machine'. Marvel Comics, April 1977. Series continues as Machine Man #1, April 1978.
- **disclosed subsystems:** `actuator-electric-direct-drive`, `mechanism-anthropomorphic-hand`, `control-rl-policy`

**Prior art notes:**

> Kirby's 1977 disclosure of Machine Man (X-51) establishes the *self-modifying modular humanoid* trope. Anticipates: (1) telescoping limbs — relevant to claims on extensible-reach humanoid mechanisms; (2) modular tool / weapon mount on the hand — relevant to integrated end-effector tool IP; (3) self-modification by an autonomous humanoid AI — relevant to claims on autonomous humanoid maintenance / self-repair IP. Continuously in Marvel canon since 1977.

**Sources:**

1. Kirby, J. 2001: A Space Odyssey #8. Marvel Comics, 1977.
2. Kirby, J. Machine Man (vol. 1). Marvel Comics, 1978-1981.
...
### 2010-01-26 — EDI (Mass Effect) *(draft)*

- **id:** `mass-effect-edi`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** BioWare
- **disclosure citation:** BioWare. Mass Effect 2 (initial EDI disclosure as ship AI). Electronic Arts, January 26, 2010. Body-acquisition disclosure: Mass Effect 3, March 6, 2012 (Dr. Eva chassis transfer).
- **disclosed subsystems:** `control-vla-vision-language-action`, `control-rl-policy`, `mechanism-anthropomorphic-hand`

**Prior art notes:**

> EDI's 2012 disclosure of an AI uploading from a ship-network into a humanoid chassis provides prior art for: (1) AI-to-embodied-platform transfer architecture — relevant to claims on portable AI substrate IP that is increasingly common in modern humanoids; (2) network-cognition-in-humanoid-body architecture (EDI retains her original ship-class cognition) — relevant to networked-mind humanoid IP. Continuously available since 2012.
...
### 2011-04-19 — Atlas and P-Body (Portal 2)

- **id:** `atlas-p-body-portal-2`
- **corpus:** fictional
- **ip status:** fictional
- **creator:** Valve Corporation
- **disclosure citation:** Wolpaw, Erik; Faliszek, Chet; Swift, Jay (writers); Valve Corporation. Portal 2. Valve, April 19, 2011.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `mechanism-anthropomorphic-hand`, `control-rl-policy`

**Prior art notes:**

> Disclosure of cooperative dual-humanoid task execution with gesture-based communication and tool-mount integration. Anticipates: (1) two-humanoid coordinated manipulation as a deployment pattern — relevant to claims on multi-humanoid task allocation IP; (2) integrated end-effector / tool combination with manipulator arm — relevant to tool-mounted manipulator claims; (3) gesture-based inter-robot communication — anticipates non-verbal coordination IP. Portal 2 is widely distributed and the cooperative campaign mode is heavily archived.

**Sources:**

1. Wolpaw, E. et al. Portal 2 (game). Valve, 2011.
2. Valve. The Final Hours of Portal 2 (production document). Valve, 2011.
...
- **disclosure citation:** Blomkamp, Neill (dir.). Chappie. Columbia Pictures / MRC, March 6, 2015.
- **disclosed subsystems:** `mechanism-bipedal-locomotion`, `control-rl-policy`, `control-vla-vision-language-action`
...
### 2017-06-12 — RLHF (Deep Reinforcement Learning from Human Preferences)
...
- **disclosure citation:** Christiano, Paul; Leike, Jan; Brown, Tom; Martic, Miljan; Legg, Shane; Amodei, Dario. 'Deep reinforcement learning from human preferences'. NeurIPS 2017, June 12, 2017 (arXiv:1706.03741).
- **disclosed subsystems:** `control-rl-policy`
...
- **disclosure citation:** Chi, C., Feng, S., Du, Y., Xu, Z., Cousineau, E., Burchfiel, B., Song, S. 'Diffusion Policy: Visuomotor Policy Learning via Action Diffusion'. arXiv:2303.04137, March 9, 2023; Robotics: Science and Systems 2023.
- **disclosed subsystems:** `control-rl-policy`, `control-vla-vision-language-action`

**Prior art notes:**

> Diffusion Policy is one of the foundational academic disclosures of generative-model action policies for robotics. Anticipates: (1) diffusion models as the policy class for robotic manipulation — directly relevant to modern claims on generative-model humanoid policies (Pi-Zero, Π0, OpenVLA all build on or extend this); (2) action chunking as a stability technique — relevant to claims on chunked-action humanoid IP; (3) multi-modal action distribution learning — relevant to claims on robust-to-demonstration-variability humanoid policies. The 2023 RSS paper and open-source code release provide extensive prior art coverage.

**Sources:**

1. Chi, C. et al. 'Diffusion Policy'. arXiv:2303.04137 (RSS 2023).
2. Diffusion Policy GitHub: https://github.com/columbia-ai-robotics/diffusion_policy
...
- **disclosure citation:** Brohan, A. et al. 'RT-2: Vision-Language-Action Models Transfer Web Knowledge to Robotic Control.' arXiv 2307.15818, July 2023.
- **disclosed subsystems:** `control-vla-vision-language-action`, `control-rl-policy`

**Prior art notes:**

> RT-2 is foundational publicly-disclosed prior art for VLA architectures applied to robotics. Any subsequent VLA patent claim must contend with this disclosure.

**Sources:**

1. arXiv 2307.15818.
2. Google DeepMind blog posts.
...
### 2024-03 — Covariant RFM-1 *(draft)*

- **id:** `covariant-rfm`
- **corpus:** private
- **ip status:** trade-secret
- **creator:** Covariant
- **disclosure citation:** Covariant public reveal of RFM-1, March 2024.
- **disclosed subsystems:** `control-vla-vision-language-action`, `control-rl-policy`

**Prior art notes:**

> Covariant RFM faces VLA prior art from Physical Intelligence π0 and the broader academic VLA literature (RT-2, Open X-Embodiment).
...
### 2024-05-20 — Octo (Open-Source Generalist Robot Policy)
...
### 2024-06-13 — OpenVLA (Open-Source Vision-Language-Action Model)
...
### 2024-07 — Skild AI foundation model *(draft)*

- **id:** `skild-foundation-model`
- **corpus:** private
- **ip status:** trade-secret
- **creator:** Skild AI
- **disclosure citation:** Skild AI public emergence, July 2024.
- **disclosed subsystems:** `control-vla-vision-language-action`, `control-rl-policy`

**Prior art notes:**

> Skild's foundation-model approach faces extensive academic prior art including RT-X, Open X-Embodiment, and π0.

**Sources:**

1. Skild AI company materials.
...
- **disclosure citation:** Black, K. et al. 'π0: A Vision-Language-Action Flow Model for General Robot Control.' arXiv 2410.24164, October 2024.
- **disclosed subsystems:** `control-vla-vision-language-action`, `control-rl-policy`

**Prior art notes:**

> π0 paper discloses VLA-with-flow-matching architecture publicly. The arXiv preprint is itself prior art for that specific architectural pattern.

**Sources:**

1. arXiv 2410.24164.
2. Physical Intelligence company materials.
