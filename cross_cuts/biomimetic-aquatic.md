...
## Octobot (first autonomous entirely-soft robot) (2016-08)

- **id**: `octobot-harvard-2016`
- **corpus**: academic
- **creator**: Harvard Wyss Institute / SEAS; Robert Wood + Jennifer Lewis + George Whitesides
- **disclosure**: Wehner, M., Truby, R.L., Fitzgerald, D.J., Mosadegh, B., Whitesides, G.M., Lewis, J.A., Wood, R.J. 'An integrated design and fabrication strategy for entirely soft, autonomous robots'. Nature 536(7617):451-455, August 2016. Harvard Wyss Institute / SEAS.
- **ip status**: academic-publication
- **prior art notes**: Octobot (Harvard Wyss + SEAS, Nature 2016) is the first autonomous entirely-soft robot. 9-year-deep academic-publication prior art. Direct shielding for any commercial humanoid or aquatic-robot claim deriving from chemical-fuel autonomous soft robots or microfluidic logic-gated control.
...
## Beihang hadal-zone pressure-tolerant soft robot (Nature 2021) (2021-03)

- **id**: `beihang-hadal-soft-robot-2021`
- **corpus**: academic
- **creator**: Beihang University + Zhejiang University + Westlake University (China); Guorui Li et al.
- **disclosure**: Li, G. et al. 'Self-powered soft robot in the Mariana Trench'. Nature 591:66-71, March 2021. Beihang University + Zhejiang University + Westlake University (China). First soft robot operating freely at hadal depth (10,900 m Mariana Trench).
- **ip status**: academic-publication
- **prior art notes**: Beihang hadal soft robot (Nature March 2021) is the first soft robot operating freely at hadal depth (10,900 m Mariana Trench). 4-year-deep academic-publication prior art. Direct shielding for any commercial humanoid or aquatic-robot claim deriving from pressure-tolerant soft robotics or hadal-zone soft-elastomer vehicles.
